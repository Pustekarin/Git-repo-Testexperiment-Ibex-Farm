...
var items  = [
	...
	["first", "DashedSentence", {s: "The firefighter saved the cat by rescuing it from the tree."},
          "Question",       {q: "How was the cat saved?",
                             as: ["By a firefighter.",
                                  "It jumped from the tree.",
                                  "It was rescued by the owner."]}],
    [["s1",1], "DashedSentence", {s: "The company informed the winner by sending her an e-mail."},
               "Question",       {q: "What did the company do?", 
									as: ["Inform the winner.", 
										"Choose a winner.", 
										"Receive an e-mail."]}],
    [["s2",1], "DashedSentence", {s: "The company informed the winner by sending him an e-mail."},
               "Question",       {q: "What did the company do?", 
									as: ["Inform the winner.", 
										"Choose a winner.", 
										"Receive an e-mail."]}],
